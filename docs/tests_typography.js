...
//этап 2
{
  question: ["Какой фактор наиболее важен при выборе шрифта для веб-проекта?"],
  answers: [{
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("tests_typography." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
